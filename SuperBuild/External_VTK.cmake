...
ELSE()
  ...
  SET(PLUSBUILD_EXTERNAL_VTK_VERSION "v9.3.1" CACHE STRING "User-selected VTK version to build Plus against")
  SET(_vtk_versions "v8.2.0" "v9.0.3" "v9.1.0" "v9.2.5 v9.3.1")
  ...
  IF(PLUSBUILD_EXTERNAL_VTK_VERSION STREQUAL "")
    SET(PLUSBUILD_EXTERNAL_VTK_VERSION "v9.3.1" CACHE STRING "User-selected VTK version to build Plus against" FORCE)
    SET(PLUSBUILD_VTK_VERSION v9.3.1 CACHE INTERNAL "Internal CMake version for VTK.")
  ELSE()
